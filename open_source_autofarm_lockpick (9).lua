    ...
    while Settings.Enabled and safeObj and safeObj.Parent do
        ...
        if CountTools("Lockpick") == 0 then
            ...
            if safeObj.Parent and not (broken and broken.Value) then
                MoveToTarget(safeObj:FindFirstChild("MainPart") or safeObj.PrimaryPart, safeObj, "target")
            end
        end
        ...
        if nameLower:find("safe") or nameLower:find("register") then
            ...
            if values then
                ...
                if broken and not broken.Value then
                    ...
                    if mainPart and (mainPart.Position.Y >= 4.8 or isSubwayZone) then
...
local function MainFarmLoop()
    ...
    while true do
        ...
        local moveSuccess, moveReason = MoveToTarget(mainPart, nextTarget, "target")
